...
function getInitialState(data: CharacterData): CharacterState {
  return {
    life: data.life,
...
export function createCharacter(
  ...
  let behaviours: Array<IBehaviour<Character>> = [];
  ...
  const addBehaviour = (behaviour: IBehaviour<Character>): void => {
