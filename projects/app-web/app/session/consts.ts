// auth session
export const SESSION_KEY_AUTH_SESSION_ID = 'sessionID';
export const SESSION_KEY_AUTH_ACCESS_TOKEN = 'accessToken';
export const SESSION_KEY_AUTH_REFRESH_TOKEN = 'refreshToken';
