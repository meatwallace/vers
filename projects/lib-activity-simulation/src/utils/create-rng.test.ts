...
test.skip('it generates a deterministic sequence of integers with the given seed', () => {
...
test.skip('it generates a deterministic sequence of array integers with the given seed', () => {
  const rng = createRNG(35_131_234);
