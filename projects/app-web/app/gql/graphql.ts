...
export type LoginWithPasswordPayload = AuthPayload | MutationErrorPayload | TwoFactorLoginPayload;
...
export type LoginWithPasswordMutation = { __typename?: 'Mutation', loginWithPassword: { __typename?: 'AuthPayload', accessToken: string, refreshToken: string, session: { __typename?: 'Session', id: string, expiresAt: string } } | { __typename?: 'MutationErrorPayload', error: { __typename?: 'MutationError', title: string, message: string } } | { __typename?: 'TwoFactorLoginPayload', transactionID: string, sessionID: string } };
